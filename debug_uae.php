...
// Test URL for Dubai plumbers
$url = 'https://www.yellowpages-uae.com/search/dubai/plumbing';
...
try {
    echo 'DEBUG: Requesting YellowPages UAE: '.$url."\n";
    ...
    $selectors = ['.company-info', '.business-card', '.listing', 'div[class*="listing"]'];
